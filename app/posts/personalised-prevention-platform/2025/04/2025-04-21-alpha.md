...
As an example entry point we’ve used results from the <a href="https://www.nhs.uk/health-assessment-tools/calculate-your-waist-to-height-ratio">calculate your waist to height ratio</a> tool, and added a call to action. This represents one of many potential routes into the platform.
...
![Screenshot of the dummy log in page](3@2x.png)
-->
...
<!--
![Example screengrab of a multiple choice preference question](11@2x.png)

![Example screengrab of a multiple choice preference question](12@2x.png)

![Example screengrab of a multiple choice preference question](14@2x.png)

![Example screengrab of a multiple choice preference question](15@2x.png)
-->
