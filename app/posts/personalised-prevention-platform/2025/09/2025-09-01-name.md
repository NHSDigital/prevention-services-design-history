...
Earlier onboarding prototypes included small goal and priority setting segments, along with asking about barriers &ndash; things that could get in the way.
...
What was surprising was how little had to be done to alleviate this &ndash; the addition of a very small amount of imagery (in some cases only a logo) and a looser approach to the content structure.
