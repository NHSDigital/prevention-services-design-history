---
title: "Recommending services"
description: "Continuing to iterate a prototype for a service that aims to help people stay healthy"
date: 2025-06-03
tags:
- alpha
- prototyping
...
Intro. Refer to last post where we did the first round. This post is about rounds 2 and 3 OR this is about round 2

Round 1 ended on a finding services spinner, so:

Round 2 was primarily to do with:

Service results and service detail - important bit is about the "I want to do this" element - proving it's bad.
The challenge of connecting in an environment that resasonably enough won't ever be reliably interop

## What we know from previous rounds

What we know from the last round:
...
Broadly what we changed:

And broadly what's new:
