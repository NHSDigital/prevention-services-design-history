---
title: "Relocating software information"
date: 2026-02-21
---

As a Class 1 Medical Device, it is a legal requirement that the NHS Health Check online service clearly displays certain information, such as the version, date of release, manufacturer and UKCA mark. From the earliest release of our service, we have displayed a lengthy Software Information panel on the start page of the service.
...
Medical devices in the UK are governed by [The Medical Devices Regulations (2002)](https://www.legislation.gov.uk/uksi/2002/618/regulation/10). These regulations are managed by the Medicines and Healthcare products Regulatory Agency (MHRA), and since the MDR only really covers physical devices, the MHRA has helpfully provided [guidance for the labelling of software](https://assets.publishing.service.gov.uk/media/64a7d22d7a4c230013bba33c/Medical_device_stand-alone_software_including_apps__including_IVDMDs_.pdf). 
...
![Figure 1 - the original start page (left), and the revised start page (middle) and new software information screen (rght)](software-information.png "Figure 1: The leftmost screen shows the original start page, with the software information positioned below the more user-centric parts of the page. The middle and right screens show the new arrangement with the start screen and software information screen separate.")