...
opengraphImage:
  src: /manage-breast-screening/2025/11/ending-breast-screening-appointments/check-information-full.png
...
It shows all data submitted through a service, with links to change each entry where required. 
