...
In usability testing the workflow seems to support appointments well, providing access to the right sections at the right time. Having a dedicated mode for the appointment allows us to have a bespoke interface tailored for different situations, and to track status as sections are completed.
