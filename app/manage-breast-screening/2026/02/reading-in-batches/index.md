...
(Note: 'Batch' is a temporary name we're using for this concept while we test it with users – we'll iterate on the terminology based on what resonates with them.)
