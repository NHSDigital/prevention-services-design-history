...
![Diagram showing a GP surgery seeking ICB approval, then notifying PCSE at least 6 weeks before the planned change.](authorisation-and-notification.png)
...
![Diagram showing primary care commissioners, public health commissioners and screening and immunisation commissioners sharing GP change information.](commissioner-connections.png)
...
![ODS shows GP surgery records and active ODS codes. BS Select uses this data to show confirmed GP code changes to BSOs.](ods-screenshot-gps.png)
...
![Diagram showing confirmed GP code changes moving from NHSBSA to ODS, then into BS Select for BSOs.](cost-centre-data-flow.png)
