...
[!Note] Data sourced from NHS, NICE and GOV.UK sources. Routine and VHR are based on breast screening reporting data, however Moderate risk are evidence informed estimates  
...
* *Acknowledge and check a referral* – BSOs will sense check someone’s eligibility (right area, right age) and return or redirect referrals if they are ineligible for that office.  

* *Check if a person is in the system* – BSOs will check BS Select and NBSS for a person’s details. If they aren’t there, they are responsible for [adding them](/select/2025/09/our-new-digital-process-for-adding-participants/). 
...
* *Complete due diligence* – Several BSOs described hunting through hospital systems to collect evidence of letters or treatments that might offer an insight into someone’s health journey so far. This helped BSOs tailor their communication to someone e.g. if they have already elected to have a bilateral mastectomy 

* *Update trackers* – BSOs may supplement digital tools with their own spreadsheets to keep track of their VHR cohort. This keeps a record of: 

	- When they were referred and from where 

	- Why they are eligible e.g. which Gene is present  
...
* *Identify who’s due for invitation* – BS Select will automatically calculate a Next Test Due Date (NTDD), but many BSOs will copy this date into their Trackers. This helps them track their workflow, and next urgent tasks depending on their protocol e.g. If MRI is in their protocol, it requires an 8-week window; mammogram only requires a 4-week window 

* *Invite a person to their mammogram or MRI (or both):* 
...
* *Close episodes and add a person to next year’s tracker* – VHR participants are invited annually 
