...
5. **Identify who’s due for invitation** – BS Select will automatically calculate a Next Test Due Date (NTDD), but many BSOs will copy this date into their Trackers. This helps them track their workflow, and next urgent tasks depending on their protocol e.g. If MRI is in their protocol, it requires an 8-week window; mammogram only requires a 4-week window 
