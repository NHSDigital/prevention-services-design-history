...
Efficiency savings from connecting vans included:

- faster image transfer - making images available for reading faster
- faster incident resolution, for example, “when a lady collapses” as forms can be accessed and completed right away
- faster quality assurance (QA) - especially when the daily, weekly and monthly QA checks fall on the same day 
- reduced risk of delivering paperwork to the wrong van
...
Less paperwork improves staff morale, because staff can spend more time doing what they are trained to do. Over time, a reliable internet connection, combined with familiarity with the setup, can help staff trust it. They learn to troubleshoot issues, which makes them feel in control: 

> We might get an odd blip, but staff don’t even tell us about it - they troubleshoot it themselves.

## Papering over the cracks

Ideally, BSOs can achieve a level of connection that allows them to work just as reliably as at base: 

> You can just update spreadsheets in real time, just like a normal computer at base.

Some BSOs have told us that their van connection service “has gone downhill”. They are dealing with it by trying to get out of the current contract before it expires and flagging unreliable service in the incident management system.
...
- how vans are connected changes based on BSO needs

## What this means for the future of Rubie

We’ve been working with the national programme team to encourage BSOs to move to a ‘[mostly online (NHS Future login required)](https://future.nhs.uk/connect.ti/vaccsandscreening/view?objectId=300472741)’ way of working and to secure funding that BSOs can apply for to improve van connectivity. 

Read more about our [research into mobile vans](/tags/mobile-vans/).