...
The breast screening programme requires daily, weekly and monthly checks to be carried out on mammography equipment [^2]. These checks “ensure that equipment is working within agreed standards and parameters and functioning safely.” With guidance from medical physicists, breast screening teams will check: 
