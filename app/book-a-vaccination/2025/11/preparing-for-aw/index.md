...
![screenshot of a page showing a list of sites offering co-admin.  Inset text near the top shows that a co-admin appointment has been chosen, and shows a link to switch to a single vaccine appointment](site-list-switching.png)
...
![Screenshot of a page showing a list of dates.  Inset text near the top shows that a co-admin appointment has been chosen, and shows a link to switch to a single vaccine appointment](date-list-switching.png)
...
![start page screenshot showing warning callout with campaign opening content](start-page-campaignopen.png)

### Date list page

We used inset text on the date selection page.

![date selection page screenshot with campaign opening content in inset text](date-list-campaignopen.png)
...
![screenshot of booking confirmation page, with action link to return users to the start of the journey, to make another booking, or manage an existing booking](confirmation-return-link.png)