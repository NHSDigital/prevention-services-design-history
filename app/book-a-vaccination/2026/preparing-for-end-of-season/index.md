...
![screenshot showing the site list page, with content explaining end dates for co-administration appointments](site-list.png) 

### Date list page 

![screenshot showing the date list page, with content explaining end dates for co-administration appointments](date-list.png)
...
![screenshot showing the start page, with closure warning content](closure-warning.png) 
...
![screenshot showing the start page, with closure warning content, and buttons/booking options removed](service-last-day.png) 
...
![screenshot showing the start page, with closed content, and buttons/booking options removed](service-closed.png) 
