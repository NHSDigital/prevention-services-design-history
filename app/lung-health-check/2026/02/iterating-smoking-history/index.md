...
![Design for a question asking users 'How often do you smoke cigars?' with 3 radio options for daily, weekly, and monthly.](Cigars-how-often.png "Design for asking users how often they smoke cigars. The options are daily, weekly, and monthly. Hint text for weekly gives an example of ‘at the weekend’. For monthly the hint text tells users to ‘select this option if you smoke cigars once a month, or once every few months.’")
...
![Design for a question asking users 'Roughly how many cigarettes do you currently smoke in a normal day?'.](Cigarettes-normal-amount.png "Design for asking users a rough estimate of the number of cigarettes they smoke in a normal day. The question will change based on their previous answer. If they answered ‘weekly’ to how often they smoke, the question will ask how many cigarettes they smoke a week.")
...
![Design for a question asking users 'Has the number of cigarettes you normally smoke changed over time?'.](Cigarettes-changed.png "Design for asking users if the number of cigarettes they smoke changed over time. The content specifying the number of cigarettes, ‘20 cigarettes a day’, is taken from their answers to previous questions. ")
