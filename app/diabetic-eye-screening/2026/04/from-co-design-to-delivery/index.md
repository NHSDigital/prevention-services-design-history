---
title: From co-design to delivery - a phased approach to improving diabetic eye screening
description: A phased, clinically assured approach to delivering improvements in diabetic eye screening cohorting
date: 2026-04-24
...
The CASCADE operational working group (CaaS Cohorting and Diabetic Eye) has been established to bring together operational, clinical, quality assurance, and pilot site stakeholders. Regular sessions provide a forum to review pilot progress, assess impacts, and support informed decision making.

A collaborative workshop held in March in Leeds supported planning for upcoming phases, ensuring alignment on system requirements, integration dependencies, and delivery sequencing.

The approach builds on the existing general practice to diabetic retinopathy screening (GP2DRS) process. It improves data quality and timeliness, and strengthens integration with national services such as the Personal Demographic Service (PDS), which holds patient demographic data.

Delivery Plan Overview

1. Cohort definition and validation
2. Technical integration
3. Controlled pilot testing
4. Rollout planning
5. Full implementation and transition

## Key phases of the delivery approach
...
This phase establishes the technical foundation for the cohorting model. It focuses on connecting systems so they can securely share data.
...
The CASCADE working group supports ongoing review and feedback.

The phase concludes once an end-to-end solution is proven to be viable and accepted.

### Phase 4. rollout planning with stakeholders
...
The phase concludes with full rollout across all providers, targeted for March 2027.

## Collaborative governance and working approach

The CASCADE operational working group meets regularly. It brings together operational, clinical, quality assurance, and pilot site representatives. It provides a structured forum for reviewing progress, assessing risks, and supporting decisions throughout pilot and rollout phases.

Clinical governance is being strengthened through the involvement of the CaaS Chief Clinical Safety Officer (CSO). This ensures alignment with existing clinical safety oversight.

Clinical safety leads from key suppliers, including NEC (OptoMize Software providers) and InHealth Intelligence, are also involved to ensure risks are clearly understood and consistently managed.
...
- Real-time feedback from services
- Iterative refinement of processes and system behaviour
- Increased confidence in clinical safety and operational viability
- Daily updates supported by PDS integration, enabling faster response to eligibility changes and improving patient safety and efficiency
