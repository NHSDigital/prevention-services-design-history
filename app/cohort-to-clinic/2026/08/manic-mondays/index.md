...
tags:
  ...
  - appointments
author: Anna Hepburn
description: Exploring new ways of structuring appointments to give users more flexibility
---
...
But it’s hard to tell how much this way of structuring clinics is influenced by the way users need to create sessions in NBSS, rather than a fundamental need to create a lot of Mondays or Tuesdays that have the same structure.
