...
Let people sync results from health kiosks (for example, in pharmacies, or libraries) into the app. Captures a moment of engagement the NHS currently has no connection to, and uses real measurements to trigger relevant service suggestions.

#### Set a health goal

Let people pick an area they want help with. For example, quitting smoking, drinking less, or eating better. Then connect them to relevant services. Designed to meet people at moments when they are already thinking about their health.

#### Next service algorithm

Use what the NHS knows about a person to suggest the most relevant prevention service for them next – either in context after they finish a task, or as a standing list of suggestions. This is the idea that ties the rest of this theme together.

### I get joined‑up care from screening to treatment

#### Targeted campaigns

Set the campaign messaging in the app (currently at the bottom of the homepage) using demographic data. Test ways of offering personalisation with lower clinical risk.

#### Missed screening follow‑up

When someone misses a screening appointment and doesn’t respond to the invitation, the app sends a follow‑up offering them a simple way to re‑engage. If they still don’t respond, a healthcare professional gets in touch directly.

#### Test results with context and next steps

Results get a permanent home in the app – connected to related tests, shown with trends over time, and explained with full context and next steps.
...
We’re prioritising these ideas based on:
