---
title: What we learnt from visiting London pharmacies
date: 2025-12-19
description: In November we visited London pharmacies who’d just started using the service. Here’s what they told us.
image:
...
Several pharmacies asked how they could remove batches which they had run out of. They were unaware of the ‘deplete’ feature, and commented that that term was unfamiliar.

Some users wanted an option to add several batches at once.
...
However, we found that some users were not aware there were 2 options and were only using 'Find a patient'.

In the new 'Record vaccinations' journey, it currently takes 7 screens before you see the patient’s details and vaccination history. Users suggested this should come earlier, as they use this information to help determine eligibility.
...
We had many comments about needing to be able to change eligibility criteria when using the ‘same vaccination, different patient’ option. This feature has since gone live.
